        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 h-full">
          <div className="flex justify-between items-center h-full">
            ...
            <Link href="/" className="z-50" onClick={() => setIsOpen(false)}>
              <span className={cn("text-2xl font-bold font-heading transition-colors duration-300", logoColor)}>
                Shantiraj<span className={scrolled ? "text-secondary" : "text-white"}>Foundation</span>
              </span>
            </Link>
